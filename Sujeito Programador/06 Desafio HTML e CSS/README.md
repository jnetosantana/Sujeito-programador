# DevMentor Brasil - Página de Login / Cadastro com HTML e CSS
...
Você precisa desenvolver duas páginas 1 para login e outra para cadastro, não precisa ser funcional, pode ser duas paginas estáticas com HTML e CSS. Você também deve deixar tambem essa página totalmente responsiva.
...
- Deve criar uma pagina de login conforme o design.
- Deve criar uma pagina de cadastro conforme o design.
...
- Sua pagina não precisa ser funcional, pode apenas ser uma pagina estática para praticar seus conhecimentos com HTML, CSS, se desafiar a desenvolver uma pagina de login / cadastro conforme passamos o layout.
